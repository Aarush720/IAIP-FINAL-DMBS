...
const DashboardPage: React.FC = () => {
  ...
  const [kpis, setKpis] = useState({ averageCgpa: '0.0', attendanceRate: '0.0', studentsAtRisk: 0, facultyLoadAvg: '0.0' });
  ...
  useEffect(() => {
    (async () => {
      try {
        const [kpiData, analytics] = await Promise.all([api.getDashboardKpis(), api.getAnalyticsData()]);
